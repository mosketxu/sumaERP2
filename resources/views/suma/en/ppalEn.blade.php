        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 align-self-center">
                    ...
                    <p> Suma Apoyo Empresarial was born with the aim of being more than just an accounting consultancy
                        and prosecutor company.</p>
                    <p> We want to accompany our clients with a personalized follow-up, knowing their business and making their needs, ours as well.</p>
                    <p> For this we have a fantastic team formed by professionals in a number of fields and with an extensive experience.
                        Thus, we can offer our clients solutions to emerging needs.
                    </p>
                </div>
                <div class="col-md-6 align-self-center">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <div class="d-flex">
                        ...
                        <div class=" align-self-start">
                           Full support services in the financial area for small and medium-sized enterprises (SME’s).
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                        ...
                        <div class="align-self-start">
                            Experts in finances, accounting and administration.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                        ...
                        <div class="align-self-start">
                            Personalized service and customer service oriented.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                        ...
                        <div class="align-self-start">
                            Business and customer insight to suit their needs.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                        ...
                        <div class="align-self-start">
                            Flexibility, methodology and confidentiality at your service.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="align-self-start">
                            We outsource specialists in different business areas: labor, fiscal, commercial.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="financiera-head-section" class="p-3">
        <div class="dark-overlay">
            <div class="col">
                <div class="container pt-5">
                    <h1 class="display-4">Financial Area</h1>
                    <p class="d-none d-md-block">Financial information is critical in decision-making.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-md-6 align-self-center order-1">
                    ...
                    <div class="d-flex">
                        ...
                        <div class=" align-self-start">
                            ...
                            Liquidity, solvency and debt structure analysis.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="align-self-start">
                            Preparation and analysis of financial ratios.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
    ...
    <section id="contable-head-section" class="p-3">
        <div class="dark-overlay">
            <div class="col">
                <div class="container pt-5">
                    <h1 class="display-4">Accounting area</h1>
                    <p class="d-none d-md-block">Accounting is a basic tool in Business Management</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <div class="d-flex">
                        ...
                        <div class=" align-self-start">
                            Specialized services for SMEs allowing companies to outsource their accounting processes.
                        </div>
                    </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class=" align-self-start">
                            Preparation of accounting processes for SME’s.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="align-self-start">
                            Help with consultations and advice on accounting criteria.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                        ...
                        <div class="align-self-start">
                             Help with sporadic excess work.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="align-self-start">
                            Self-employed accounting assistance.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                        ...
                        <div class="align-self-start">
                            Our accounting advice service is complemented with financial, tax and commercial advice.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 align-self-center order-1">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="align-self-start">
                            Follow-up and/or payment management.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
                        ...
                        <div class="align-self-start">
                            Follow-up and/or collection management.
                        </div>
                    </div>
                    <div class="d-flex">
                        <div class="align-self-center pr-4 pb-2">
